...
namespace FilmesAPI.Controllers
{
    ...
    public class CinemaController : ControllerBase
    {
        ...
        {
            List<ReadCinemaDto>  readCinemasDto = _cinemaService.RecuperaCinemas(nomeDoFilme);

            if (readCinemasDto == null) return NotFound();
    

            return Ok(readCinemasDto);
        }

        [HttpGet("{id}")]
        public IActionResult RecuperaCinemasPorId(int id)
        {
            ReadCinemaDto readDto = _cinemaService.ReacuperaCinemasPorId(id);
